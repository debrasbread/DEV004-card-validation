...
- Brinda a los usuarios (vendedores) un espacio del que no disponen para anunciar sus productos acompañados de un relato personal.
- El registro, que supone el pago del espacio para anunciar, es sencillo. Además, pagar con tarjeta en línea siempre será más fácil y práctico que cualquier otro método.

## Sobre la aplicación

La estructura del sitio, su estilo o apariencia visual y las interacciones fueron diseñados en HTML, CSS y JavaScript, respectivamente.
